...
class CommandCodes(IntOrTypeEnum):
    ...
    DISPLAY_BRIGHTNESS = 0x01, APIVERSION_AVR_SA_AND_ST_SERIES, EnumFlags.FULL_UPDATE
    ...
    DIRECT_MODE_STATUS = 0x0F, APIVERSION_DIRECT_MODE_SERIES, EnumFlags.FULL_UPDATE  # Request
    ...
    DOLBY_PLII_X_MUSIC_PANORAMA = 0x3E, APIVERSION_450_SERIES, EnumFlags.FULL_UPDATE
