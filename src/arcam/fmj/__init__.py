...
class CommandCodes(IntOrTypeEnum):
    ...
    DOLBY_PLII_X_MUSIC_DIMENSION = 0x3C, APIVERSION_450_SERIES, EnumFlags.FULL_UPDATE
    DOLBY_PLII_X_MUSIC_CENTRE_WIDTH = 0x3D, APIVERSION_450_SERIES, EnumFlags.FULL_UPDATE
    ...
    MAXIMUM_TURN_ON_VOLUME = 0x65, APIVERSION_APP_SAFETY_SERIES, EnumFlags.FULL_UPDATE
    MAXIMUM_VOLUME = 0x66, APIVERSION_APP_SAFETY_SERIES, EnumFlags.FULL_UPDATE
    MAXIMUM_STREAMING_VOLUME = 0x67, APIVERSION_APP_SAFETY_SERIES, EnumFlags.FULL_UPDATE
